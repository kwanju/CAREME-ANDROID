...
public class VolunteerRecordActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        volunteerRecords.add(new VolunteerRecord("유기견보호소1", "댕댕이", "May 7, 2019", "Permitted"));
        volunteerRecords.add(new VolunteerRecord("유기견보호소2", "멍멍이", "May 17, 2019", "Not Permitted"));
